...
local mod_get_orig = mod.get
local mod_get_cache = {}
local mod_get_checked = {}
mod.get = function(self, k)
	if not mod_get_checked[k] then
		mod_get_cache[k] = mod_get_orig(self, k)
		mod_get_checked[k] = 1
	end
	return mod_get_cache[k]
end
